...
| **Mercado de plugins Claude + Codex** | Un árbol compartido de 13 plugins incluye manifests de Claude Code y Codex, dos catálogos, 62 habilidades empaquetadas, 17 subagentes de Claude, 33 comandos de Claude y metadatos OpenAI. La CLI de skills.sh descubre 70 habilidades del repositorio con `npx skills add hoangsonww/Claude-Code-Agent-Monitor --list`. Se instala con `claude plugin marketplace add`, `codex plugin marketplace add` o `npx skills add` |
...
CCAM incluye 13 plugins compartidos por Claude Code y Codex, 62 habilidades empaquetadas, 17 subagentes de Claude, 33 comandos de Claude, 3 herramientas CLI, 3 configuraciones de hooks y 2 plugins con MCP. La CLI de skills.sh descubre 70 habilidades en todo el repositorio. Consulta `docs/PLUGINS.md` para el catálogo, la instalación y la validación.
...
|--------|----------------|--------|
| **ccam-analytics** | `instalar plugin claudé ccam-analytics@claude-code-agent-monitor-plugins` | `reporte de sesión`, `desglose de costos`, `tendencias de uso`, `puntuación de productividad` |
...
| **ccam-productividad** | `instalar plugin claudec ccam-productivity@claude-code-agent-monitor-plugins` | `daily-standup`, `weekly-report`, `sprint-summary`, `workflow-optimizer` |
...
| **ccam-insights** | `instalar plugin claudec ccam-insights@claude-code-agent-monitor-plugins` | `detectar patrones`, `alerta de anomalías`, `sugerencias de optimización`, `comparar sesiones` |
...
| **calidad ccam** | `instalar plugin claudecam-quality@claude-code-agent-monitor-plugins` | `escaneo de errores`, `reporte de errores de API`, `auditoría de fallos de gancho`, `verificación slo`, `alerta de regresión` |
...
|-- .claude-plugin/
|   +-- marketplace.json        # Manifest del mercado Claude Code (13 plugins)
|-- .agents/plugins/
|   +-- marketplace.json        # Manifest del mercado Codex (13 plugins)
|-- plugins/
