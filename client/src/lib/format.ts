 ...
 *    parsed as-is.
 * 2. **Locale awareness.** The dashboard ships six UI languages (English, Chinese,
 *    Vietnamese, Korean, Spanish, French). {@link getCurrentLocale} maps the active i18next language to a
 *    BCP-47 tag (`en-US`, `zh-CN`, `vi-VN`, `ko-KR`, `es-ES`, `fr-FR`) that the `Intl`/`toLocale*` APIs
...
type SupportedLanguage = "en" | "zh" | "vi" | "ko" | "es" | "fr";
 ...
 * @returns One of `"zh-CN" | "vi-VN" | "ko-KR" | "es-ES" | "fr-FR" | "en-US"`.
