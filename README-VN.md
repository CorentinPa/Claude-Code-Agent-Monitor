...
| `DASHBOARD_REMOTE_SYNC_MS` | `15000` | Khoảng thời gian (ms) để kéo dữ liệu từ các nguồn từ xa qua `rsync`. Thêm hoặc bật lại nguồn cũng kích hoạt đồng bộ ngay. Đặt `0` để tắt việc poll nguồn từ xa |
