...
| **Tự động khám phá**                 | Phiên và tác nhân được tạo tự động từ các sự kiện hook. Claude Code tạo thẻ **Đang chờ** ngay tại `SessionStart`; Codex cũng vậy qua hook hoặc, nếu hook bị trì hoãn để duyệt độ tin cậy, qua chỉ mục live-thread cục bộ. Rollout đến sau làm giàu chính hàng đó. |
